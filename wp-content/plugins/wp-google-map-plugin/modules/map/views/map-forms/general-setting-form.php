...
$form->add_element( 'text', 'map_title', array(
	...
	'desc' => esc_html__( 'Enter here the map title.', 'wp-google-map-plugin' ),
	'required' => true,
	'placeholder' => '',
));
$form->add_element( 'text', 'map_width', array(
	...
	'desc' => esc_html__( 'Enter here the map width in pixel. Leave it blank for 100% width.', 'wp-google-map-plugin' ),
	'placeholder' => '',
));
$form->add_element( 'text', 'map_height', array(
	...
	'desc' => esc_html__( 'Enter here the map height in pixel.', 'wp-google-map-plugin' ),
	'required' => true,
	'placeholder' => '',
));
...
$form->add_element( 'select', 'map_zoom_level', array(
	...
	'desc' => esc_html__( 'Available options 0 to 19.', 'wp-google-map-plugin' ),
	'options' => $zoom_level,
	'default_value' => 5,
));
