    ...
    <div class="cli-row">
        ...
        <?php endif; ?>
            ...
            { 
                ...
                $ccpa_applicable = ( isset( $cookie['ccpa_optout'] ) ? $cookie['ccpa_optout'] : 0 );
                
                $ccpa_category_identity = ( $ccpa_applicable == 1 ) ? 'data-cli-ccpa-optout' : '' ;
                ?>
                ...
                ?>  
                    <div class="wt-cli-necessary-checkbox">
                        <input type="checkbox" class="cli-user-preference-checkbox"  id="wt-cli-checkbox-<?php echo $key; ?>" data-id="checkbox-<?php echo $key; ?>" checked="checked"  />
                ...
                <div class="cli-switch">
                    <input type="checkbox" class="cli-user-preference-checkbox" <?php echo $ccpa_category_identity;?> id="wt-cli-checkbox-<?php echo $key; ?>" data-id="checkbox-<?php echo $key; ?>" <?php checked( $checked, true); ?>  />
