...
<div class="clear"></div>
    ...
    <?php $subproperties = wp_list_sort( $subproperties, array( 'post_title' => 'ASC' ) ); ?>
    ...
    <?php if ( is_array( $subproperties ) && ! empty( $subproperties ) ) : ?>
        <div class="subproperties">
            ...
            if($parentId):
             ...
             ?>
		        <a class="btn gem-button btn-brand" style="border-radius: 3px;	margin: 0 0 20px;" onmouseleave="" onmouseenter="" href="<?=get_permalink($parentId)?>" target="_self"><?=$parent_post->post_title?></a>
            <?php endif; ?>
            <div class="row">
