	...
	<div class="container">
		<div class="top-area-items inline-inside">
			<?php if(thegem_get_option('top_area_contacts')) : ?> 
				<div class="top-area-block top-area-contacts"/><div class="gem-contacts inline-inside"><div class="gem-contacts-item gem-contacts-phone"><?php _e( '+32 87 87 10 10', 'top-area' ); ?></div></div></div>
			<?php endif; ?>
			...
			<?php if(has_nav_menu('top_area') || thegem_get_option('top_area_button_text')) : ?>
				...
				<div class="top-area-block top-area-button right"><div class="gem-button-container gem-button-position-inline"><a class="gem-button gem-button-size-tiny gem-button-style-flat gem-button-text-weight-normal gem-button-no-uppercase" style="border-radius: 3px;" onmouseleave="" onmouseenter="" href="<?php _e( 'http://tpalm.be/2017/contact-construction-maison/', 'top-area' ); ?>" target="_self"><?php _e( 'DEMANDER VOTRE CATALOGUE', 'top-area' ); ?></a></div></div>
			<?php endif; ?>
				</div>
			<?php endif; ?>
