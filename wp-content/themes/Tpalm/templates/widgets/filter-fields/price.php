<?php if ( empty( $instance['hide_price'] ) ) : ?>
	<div class="form-group">
		...
		<input type="text" name="filter-price-from"
				<?php if ( 'placeholders' == $input_titles ) : ?>placeholder="<?php echo __( 'Prix minimum', 'realia' ); ?>"<?php endif; ?>
	...
	<div class="form-group">
		...
		<input type="text" name="filter-price-to"
				<?php if ( 'placeholders' == $input_titles ) : ?>placeholder="<?php echo __( 'Prix maximum', 'realia' ); ?>"<?php endif; ?>
