...
class Aviators_Widget_Call_To_Action extends WP_Widget {
    function __construct( $id_base = null, $name = null, $widget_options = array(), $control_options = array() )  {
        ...
        if ( ! $name ) {
            $name = __( 'Call To Action', 'realocation' );
        }

        $widget_ops = array( 'description' => __( 'Call to action button.', 'realocation' ) );
       ...
       ?>
        ...
        <div class="<?php echo esc_attr( $instance['class'] ); ?>">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="<?php echo wp_kses( $instance[ 'button_link' ], wp_kses_allowed_html( 'post' ) ); ?>" class="btn btn-dark" >
    ...
    function form( $instance ) {
        ...
        <p>
            <?php echo __( 'Text:', 'realocation' ); ?>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'text' ) ); ?>" type="text" value="<?php echo esc_attr( $text ); ?>"/>
        </p>

        <p>
            <?php echo __( 'Button Text:', 'realocation' ); ?>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'button_text' ) ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>"/>
        </p>

        <p>
            <?php echo __( 'Button Link:', 'realocation' ); ?>
